$(document).ready(function () {
    ...
    $('ul.main-menu li a').each(function () {
    	...
    	var w_href = String(window.location);
    	var index_a_href = a_href.indexOf("&token");
    	var index_w_href = w_href.indexOf("&token");
    	if(a_href.indexOf("#")==-1 && index_a_href!=-1) {
    		a_href = a_href.substring(0,index_a_href);
    	}
    	if(index_w_href!=-1) {
    		w_href = w_href.substring(0,index_w_href);
    	}
        if (a_href == w_href)
    ...
    //STP custom
    $('.accordion li.active:first').parents('ul').parents('li').removeClass('active');
});
